namespace TMDB.Data.Provider.IMDB.Models
{
	using System;
	...
	public class MovieJsonModel
	{
		...
		public Movie GetMovieModel(TmdbContext dbContext)
		{
			if (this.Title == null)
			{
				return null;
		...
		private ICollection<Person> GetPersonsCollection(string names, TmdbContext dbContext, JobPositionType jobType)
		{
		...
		private Person GetPerson(string name, TmdbContext dbContext, JobPositionType jobType)
		{
